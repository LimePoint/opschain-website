...
1. **Observability with context.** Knowing not just *what* happened, but *why*.  
...
1. **Manual operations.** Human-driven approvals, scripts, and interventions.  
2. **Automated operations.** Task-level automation with limited governance.  
